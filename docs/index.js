	  ...
	  Calculator.prototype.render = function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(_Button2.default, { classType: 'unit', display: '%', onClick: function onClick() {
